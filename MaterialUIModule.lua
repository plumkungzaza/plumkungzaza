...
function Material.Load(Config)
	...
	function TabLibrary.New(TabConfig)
		...
		function CreateNewKeybind(presetKeyCode, ButtonConfig, Parent)
			local ButtonText = ButtonConfig.Text or "nil button"
			local ButtonCallback = ButtonConfig.Callback or function() print("nil button") end
			local Menu = ButtonConfig.Menu or {}
			local KCode = presetKeyCode.Key or {}
			...
			local ButtonLabel = Objects.new("Label")
			ButtonLabel.Text = ButtonText .. ": " .. presetKeyCode or ButtonText .. ": " .. "none"
			ButtonLabel.TextColor3 = ThisTheme.ButtonAccent
			ButtonLabel.Font = Enum.Font.GothamSemibold
			ButtonLabel.TextSize = 14
			ButtonLabel.ClipsDescendants = true
			...
			local presetKeyCode = KCode or presetKeyCode and presetKeyCode
			local keyCode = "P"
			local shortNames = {
		...
		function OptionLibrary.Keybind(presetKeyCode, KeybindConfig)
			local NewButton, KeybindLabel = CreateNewKeybind(presetKeyCode, KeybindConfig, PageContentFrame)
