...
function TryAddMenu(Object, Menu, ReturnTable)
	...
	if Total > 0 then
        ...
        InputService.InputBegan:Connect(function(input, onGui)
             if not onGui and (input.KeyCode == Enum.KeyCode.P or input.KeyCode == Enum.KeyCode.LeftAlt) then
				--MenuBuild.Visible = not MenuBuild.Visible
				MenuBuild.Enabled = not MenuBuild.Enabled
            end
        end)
